...
def e2e_generation(video_name:str, song_name:str):
    video_path = script_dir / "Input_Videos" / f"{video_name}.mp4"
    song_path = script_dir / "AI_Songs" / f"{song_name}.wav"
    output_path = script_dir / "Output_Videos" / f"{video_name}.mp4"
    ...
    generate_song(description, duration, song_name)
